    ...
    for result in new_results:
        ...
        response_list.append(
            MatchResultResponse(
                ...
                check_item_value_type=str(item.value_type) if item.value_type else "numeric",
                check_item_value=cast(float | None, item.value),
                check_item_text_value=str(item.text_value) if item.text_value else None,
                check_item_unit=str(item.unit) if item.unit else None,
